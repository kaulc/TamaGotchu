...
public class Pet {
	...
	private String[] inventory = new String[INV_SIZE];
	...
	public Pet(int age, int health, String name, double level, boolean isMale,
			int points,double hunger, String[] inventory, int numItems, boolean isDead ) {
...
/*	
	...
	public void addInventory(object) {
		inventory[numItems] = item;
		numItems++;
		
	}
	
	public void removeInventory(object) {
