...
public class GamePlay {
	...
	// static Protagonist p = new Protagonist(50, 3, 15, 4000); // STATS WILL BE
	// IMPORTED FROM OTHER PET CLASSES
	...
	public static void main(String[] args) {
		...
		System.out
				.println("- In this castle lies a room of riches. If you find it, you keep it. Enter at your risk.\n");
				...
				while (stepCounter < numSteps && play) {
					...
					if (choice == 1) {
						...
						if (tempAns.equals("d")) {
							...
							System.out.println("You walk away from the apple.");
						choice = 4;
					} else if (choice == 2) {
						...
						if (tempAns.equals("d")) {
							...
							if (temp == 0) {
								...
								if (tempAns.equals("d")) {
									...
									System.out.println("You walk away from the apples.");
	...
	private static Boolean fightMonster(Monster m) {
		...
		while (p.checkHealth() == true && m.checkHealth() == true) { // fight till someone dies
			if (petTurn == 1) {
				...
				petTurn = 0;
				/*
				 * System.out.println("Press any key to continue"); keypress = false; sc.next();
